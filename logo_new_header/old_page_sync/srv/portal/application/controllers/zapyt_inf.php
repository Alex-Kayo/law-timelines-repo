...
class Zapyt_inf_Controller extends Front_Controller {
     ...
     public function __construct() {
       ...
       // $this->view->front = false;
        ...
        $this->view("zapyt_inf_subsite/main_zapyt");
...
//     $SeoAppointments = "notice9skl";
     ...
     $this->view->doc_zapyt=$this->model->FindBySeo('news',  $SeoAppointments,  $this->siteLang, $mainPageCount['tsk_topnews']);
     $this->view->infzapyt_type=$this->model->FindBySeo('documents',  'infzapyt_type',  $this->siteLang, $mainPageCount['tsk_topnews']);
     $this->view->zvity_pubinf=$this->model->FindBySeo('documents',  'zvity_pubinf',  $this->siteLang, $mainPageCount['tsk_topnews']);
     $this->view->forms_zapyt=$this->model->FindBySeo('documents',  'forms_zapyt',  $this->siteLang, $mainPageCount['tsk_topnews']);
