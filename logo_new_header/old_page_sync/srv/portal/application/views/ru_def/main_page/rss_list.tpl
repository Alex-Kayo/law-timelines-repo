<div class="right_col">
    ...
    {if $panel_config->l_block1_status eq 1 && $block_data.1.items.total_rows}
        <div class="heading">
            <h3>
                <a href="{$lang_prefix}/{$block_data.1.topic->i_categories}" class="show_section">Перейти к разделу</a>
                <span>{$block_data.1.topic->t_name}</span>
                <a href="ru/rss/preview/anonsy_podij_ru" class="rss_ico"></a>
            </h3>
        </div>
                  ...
                  <div class="announce_list">
                      <div class="announce_overflow">
                            ...
                            {foreach item=data from=$block_data.1.items}
                                <p>
                                    <span class="announce_date">{$data->day}&nbsp;{$data->month} в {$data->hour}</span>
<!--                                    <span class="announce_txt"><a href="{$data->i_link}">{$data->i_name}</a></span>-->
    ...
    {if $panel_config->l_block2_status eq 1}
        <div class="heading">
            <h3>
                <a href="{$lang_prefix}/{$block_data.2.topic->i_categories}" class="show_section">Перейти к разделу</a>
                <span>{$block_data.2.topic->t_name}</span>
                <a href="https://w1.c1.rada.gov.ua/pls/radac_gs09/golos_rss" class="rss_ico"></a>
            </h3>

            {if $block_data.2.topic->t_name == 'Ход пленарных заседаний'}
                <div class="block_submenu">
                        <ul>
                            <li><a href="https://w1.c1.rada.gov.ua/pls/radan_gs09/h_index_n">Хронология рассмотрения</a></li>
                            <li class="borderl"><a href="https://w1.c1.rada.gov.ua/pls/radan_gs09/pd_index_n">Результаты рассмотрений</a></li>
                       </ul>
                </div>
            {/if}
        </div>
    ...
    {if $panel_config->l_block3_status eq 1}
        <div class="heading">
            <h3>
{*                  <a href="{$lang_prefix}/{$block_data.3.topic->i_categories}" class="show_section">  Перейти к разделу</a>*}
{*                  <span>{$block_data.3.topic->t_name}</span>  *}
            ...
            <div class="block_submenu">
                    <ul>
                        <li><a href="https://w1.c1.rada.gov.ua/pls/zweb2/webproc555">Зарегистрированные за текущую неделю</a></li>
                        <li class="borderl"><a href="https://w1.c1.rada.gov.ua/pls/site2/p_bills_stand_laws">Принятые на текущей сессии</a></li>
                        <li class="borderl"><a href="https://w1.c1.rada.gov.ua/pls/zweb2/webproc2">Поиск по реквизитам</a></li>
                    </ul>
            </div>
        </div>
        <div class="information_block">
    ...
    {if $panel_config->l_block4_status eq 1}
        <div class="heading">
            <h3>
{*                  <a href="{$lang_prefix}/{$block_data.4.topic->i_categories}" class="show_section">  Перейти к разделу</a>*}
{*                  <span>{$block_data.4.topic->t_name}</span>  *}
                <span>Законодательство Украины</span>
                <a href="https://zakon2.rada.gov.ua/laws/main/xml" class="rss_ico"></a>
            </h3>

            <div class="block_submenu">
                    <ul>
                        <li><a href="https://iportal.rada.gov.ua/uploads/documents/27396.pdf">Конституция Украины</a></li>
                        <li class="borderl"><a href="https://zakon2.rada.gov.ua/laws/main/t21">Кодексы Украины</a></li>
                        <li class="borderl"><a href="https://zakon2.rada.gov.ua/laws/main/o1/find?typ=1">Законы Украины</a></li>
                        <li class="borderl"><a href="https://zakon2.rada.gov.ua/laws/main/a#Find">Поиск по реквизитам</a></li>
                    </ul>
            </div>
        </div>
        <div class="information_block">
 ...
 {*   <div class="heading multimedia">
        <h3>
            <a href="{$lang_prefix}/gallery" class="show_section" id="media_show">Перейти к разделу</a>
    ...
    <div class="information_block multimedia">
        <div class="tabs_block">
            <ul>
                <li class="first"><a href="#video_tab">Видео</a></li>
                <li><a href="#photo_tab">Фото</a></li>
                <li><a href="#audio_tab">Аудио</a></li>
            </ul>
            <!-- photo -->
