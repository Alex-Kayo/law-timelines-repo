        ...
        {foreach item=media_data from=$list_gallery}
            {if $index_cell == 0}
                ...
                <div class="gallery_item">
                    <div class="item_foto"><a href="{$lang_prefix}/{$media_data->i_categories}/{$media_data->i_id}.html?{$show_request}"><img alt="{$media_data->i_name}" src="/uploads/gallery_prev/{$media_data->filename}" height="100" width="148"/></a>
                    </div>
