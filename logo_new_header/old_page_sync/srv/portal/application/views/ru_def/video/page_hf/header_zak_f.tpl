            ...
            <meta name="keywords" content="{$meta.keywords}">
                ...
                <link rel="stylesheet" href="{$site_domain}sources/{$th_folder}/main_page/menu_div.css" type="text/css" media="all" />
                    ...
                    <div id="wrapper">
                        ...
                        <!-- #header-->
                        <link media="screen" type="text/css" rel="stylesheet" href="https://static.rada.gov.ua/css/vru_custom.css">

                            <div id="PlsqlBody">


                                <script type="text/javascript" src="{$site_domain}sources/default/gallery/jquery.jcarousel.pack.js"></script>
                                <link rel="stylesheet" type="text/css" href="{$site_domain}sources/default/gallery/jquery.jcarousel.css">
                                    <link rel="stylesheet" type="text/css" href="{$site_domain}sources/default/gallery/skin.css">
                                        {literal}
                                            <style type="text/css">
                                                ...
                                                <div class="panel1">
                                                    <div class="panel2">
                                                        <div class="panel-head clr">
                                                            <span class="photo-head-link">{$frame_subtitle}</span>                                  
