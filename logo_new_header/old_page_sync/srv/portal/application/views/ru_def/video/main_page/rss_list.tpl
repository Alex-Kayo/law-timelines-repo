<div class="right_col">
    ...
    {if $panel_config->l_block1_status eq 1}
        <div class="heading">
            <h3>
                <a href="{$block_data.1.topic->i_categories}" class="show_section">Перейти до розділу</a>
                ...
                <div class="announce_list">
                    <div class="announce_overflow">
                        ...
                        {foreach item=data from=$block_data.1.items}
                            <p>
                                <span class="announce_date">{$data->day}&nbsp;{$data->month} о {$data->hour}</span>
<!--                                    <span class="announce_txt"><a href="{$data->i_link}">{$data->i_name}</a></span>-->
    ...
    {if $panel_config->l_block2_status eq 1}
        <div class="heading">
            <h3>
                <a href="{$block_data.2.topic->i_categories}" class="show_section">Перейти до розділу</a>
            ...
            {if $block_data.2.topic->t_name == 'Хід пленарних засідань'}
                <div class="block_submenu">
                    <ul>
                        <li><a href="https://w1.c1.rada.gov.ua/pls/radac_gs09/h_index_n">Хронологія розгляду</a></li>
                        <li class="borderl"><a href="https://w1.c1.rada.gov.ua/pls/radac_gs09/pd_index_n">Результати розгляду</a></li>
                    </ul>              
                </div>                
            {/if}
        </div>    
...
{if $panel_config->l_block3_status eq 1}
    <div class="heading">
        ...
        <div class="block_submenu">
            <ul>
                <li><a href="https://w1.c1.rada.gov.ua/pls/zweb_n/webproc555">Зареєстровані за поточний тиждень</a></li>
                <li class="borderl"><a href="https://w1.c1.rada.gov.ua/pls/site/p_bills_stand_laws">Прийняті на поточній сесії</a></li>
                <li class="borderl"><a href="https://w1.c1.rada.gov.ua/pls/zweb_n/webproc2">Пошук за реквізитами</a></li>
            </ul>              
        </div>                            
    </div>    
    <div class="information_block">
...
<div class="information_block multimedia">
    <div class="tabs_block">                       
        <ul>
            <li class="first"><a href="#photo_tab">Фото</a></li>
            <li><a href="#video_tab">Вiдео</a></li>
