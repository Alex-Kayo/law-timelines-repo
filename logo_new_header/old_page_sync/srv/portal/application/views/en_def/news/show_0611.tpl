                ...
                <div class="text-column col-md-6">
                    ...
                    <div class="social-aside">
                        <div>
                            ...
                            <div class="fb-share-button" data-href="https://rada.gov.ua{$base_url}{$i_id}.html" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https://rada.gov.ua{$base_url}{$i_id}.html&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Поділитись</a></div>
...
{*                  <a href="/{$lang_prefix}/{$data->t_parents}/{$current_node->t_seo_name}">Переглянути ще</a>*}
                  <a href="{$base_url}">Переглянути ще</a>
