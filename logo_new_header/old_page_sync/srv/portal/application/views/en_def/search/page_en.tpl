...
<!-- advanced request -->
                            ...
                            <div id="advanced" class="collapse advanced-request">
                                <ul>
                                    ...
                                    <li>
                                       ...
                                       <div class="small-example"><b>For example:</b> query "low" - will find "low", and query "low*" — will find "low, legislation, law project" and etc.</div>
                                    </li>
                                </ul>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="date_point" value="{$var_data.date_point}" class="en-datepicker form-control" placeholder="Please select a date">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="field" id="exampleRadios1" value="0" {$fcheck0}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="field" id="exampleRadios2" value="1" {$fcheck1}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="field" id="exampleRadios3" value="2" {$fcheck2}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="field" id="exampleRadios4" value="3" {$fcheck3}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="sort" id="exampleRadios6" value="2" {$scheck2}>
                                <label class="form-check-label" for="sort1">
                                    By date of publication
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="sort" id="exampleRadios5" value="1" {$scheck1}>
