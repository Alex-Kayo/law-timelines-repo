...
<div class="page-heading">
    ...
    <h3>
        {if $current_node->t_name != "Текстові публікації"}
        {$current_node->t_name}
        {else} 
        Усі текстові публікації
        {/if}    
                ...
                <div class="full-mob-width">
                    <div class="digest-section digest-small">
                        <div class="content">
                            ...
                            <div class="digest-section__heading">Парламентський дайджест</div>

                            <p>Отримуй головне з порталу Верховної Ради у свою скриньку</p>
                            ...
                            <form>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="info-ico">
                                        ...
                                        На настопному кроці ви зможете налаштувати категорії матеріалів у розсилці та її частоту
                                    </div>

                                    <button class="btn btn-white" type="button">Продовжити</button>
