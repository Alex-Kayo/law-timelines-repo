...
{*<span class="rada-cab">
                        <p class="mob-hide hide-select" style="text-align: left; /*! position:absolute; */ opacity: 1;font-weight: 600; right: 65px; top:90px;">
                            <a href="https://itd.rada.gov.ua/idsrv/"><span class="mob-hide hide-select" style="display: inline-block;  padding: 0px 15px;color: white;margin-top: 5px;">
Electronic cabinet of a citizen </span></a></p> </span>*}
                    </div>
                    {*<!-- end lang block -->*}
