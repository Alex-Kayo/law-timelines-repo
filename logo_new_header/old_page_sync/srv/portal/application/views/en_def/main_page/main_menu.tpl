                            ...
                            <div class="submenu_table">
                                <div class="submenu_row">
                                    <div class="submenu_col">
                                        ...
                                        <ul>
                                            <li><a href="http://zakon.rada.gov.ua/go/en">Ukrainian legislation</a></li>
                                            <li><a href="http://zakon.rada.gov.ua/go/en/a#Find">Search by attributes</a></li>
                                            <li><a href="http://zakon.rada.gov.ua/go/en/nn">Latest additions of parliamentary enactments</a></li>
                                            <li><a href="http://zakon.rada.gov.ua/go/en/c">Міжнародні документи</a></li>
...
{*                                            <li><a href="https://www.kmu.gov.ua/ua/diyalnist/yevropejska-integraciya/perekladi-aktiv-acquis-yes">Translation of EU legal acts</a></li>*}
                                            <li><a href="http://zakon.rada.gov.ua/go/en/d">Popular documents</a></li>
                                            <li><a href="http://zakon.rada.gov.ua/go/en/perv">Initial acts of law</a></li>
                                    ...
                                    <div class="submenu_col divider_col">
                                        <ul>
                                            <li><a href="http://zakon.rada.gov.ua/go/en/koms">Breakdown by VRU committees</a></li>
                                            <li><a href="http://zakon.rada.gov.ua/go/en/annot">Act summaries in English</a></li>
                                            <li><a href="http://zakon.rada.gov.ua/go/en/termin">Legislative glossary</a></li>
                                            <li><a href="http://zakon.rada.gov.ua/go/en/krym">Legislation of AR Crimea</a></li>
                                        </ul>
                                    </div>
                                    <div class="submenu_col">
                                        <h3>Legal framework of parliamentary activities</h3>
                                        <ul>
                                            <li><a href="http://zakon.rada.gov.ua/go/en/254%D0%BA/96-%D0%B2%D1%80">Constitution of Ukraine</a></li>
                                            <li><a href="http://zakon.rada.gov.ua/go/en/1861-17">Law on Verkhovna Rada’s rules of procedure</a></li>
                                            <li><a href="http://zakon.rada.gov.ua/go/en/2790-12">Law on status of a Ukrainian parliamentarian</a></li>
                                            <li><a href="http://zakon.rada.gov.ua/go/en/116/95-%E2%F0">Law on VRU committees</a></li>
{*                                            <li><a href="http://zakon2.rada.gov.ua/rada/show/n0001001-15">Coalition agreement of parliamentary factions “European Ukraine”</a></li>*}
                                            <li><a href="http://zakon.rada.gov.ua/go/en/769/11-%D1%80%D0%B3">VRU Administration regulations</a></li>
                                            <li><a href="http://zakon.rada.gov.ua/go/en/pravbase">Complete list of documents</a></li>
                                        </ul>
                                    </div><!--/submenu_col-->
                                </div><!--/submenu_row-->
                            </div><!--/submenu_table-->
