            ...
            <div id="header">
                ...
                <div class="header_body">
                    ...
                    <div class="logo-main">
                       ...
                       {* <p class="mob-hide" style="text-align: left; position:absolute; opacity: 1;font-weight: 600; right: 65px; top:150px;">
                            <a href="https://itd.rada.gov.ua/idsrv/en"><span style="display: inline-block;  padding: 0px 10px;">Electronic cabinet  of a citizen </span></a></p>*}
                ...
                <nav id="navbar" class="navbar navbar-dark navbar-expand-lg">
                    <span class="navbar-brand">
                        <a href="/en" class="vru__logo">Verkhovna Rada of Ukraine</a>
                    </span>
                        ...
                        <div class="form-inline my-2 my-lg-0">
                            <ul class="map_menu">
                                ...
                                <li>
                                    ...
                                    <a class="telegram-ico" href="https://t.me/verkhovnaradaofukraine" target="_blank" title="Telegram">                                         <i class="fab fa-telegram-plane"></i>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <a class="twitter-ico" href="https://twitter.com/ua_parliament?s=21&t=yYReODyOF6eSQP-atB2U1w" target="_blank" title="Twitter">    
                                        <i class="fab fa-twitter"></i>
                                    </a>
                                </li>
                                <li>
                                    {*<a class="facebook-ico" href="https://www.facebook.com/verkhovna.rada.ukraine/" target="_blank" title="Facebook">*}
                                  <a class="facebook-ico" href="https://www.facebook.com/profile.php?id=100089703132729" target="_blank" title="Facebook">
...
<div id="cab_grom">
{*    <a href="https://iportal.rada.gov.ua" target="_blank" class="old-version">Older version of webportal</a>*}
    <a href="https://itd.rada.gov.ua/idsrv/en" target="_blank" class="rada_cab">Electronic cabinet  of a citizen</a>
