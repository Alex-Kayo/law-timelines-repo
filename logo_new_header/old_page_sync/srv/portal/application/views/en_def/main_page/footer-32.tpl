...
{*                            <li><span>Verkhovna Rada in social networks:</span></li>*}
                            ...
                            <li>
                                <a class="instagram-ico" href="https://www.instagram.com/verkhovna_rada_/" target="_blank" title="Інстаграм">
        ...
        <div class="row">
                    ...
                    <div class="col-lg-8 col-md-6 order-md-2">
                        ...
                        <ul class="column-2-list-bold">
                            ...
                            <li><a href="http://vzvernen.rada.gov.ua/" target="_blank">Department of citizens appeals</a></li>
