...
{*{literal}
  ...
  background: linear-gradient(135deg, #22324D 0%, #122443 100%);
...
<ul class="navbar-nav mr-auto">
    <li class="nav-item">
        <a class="nav-link" href="/structure_parlam" title="Склад і структура | Архів за скликаннями">Склад і структура</a>
    </li>
                                ...
                                <div class="submenu_row">
                                    <div class="submenu_col">
                                        ...
                                        <ul>
                                           ...
                                           {* <li><a href="#">Картка законопроекту</a></li>
                                            <li><a href="#">Вкладки</a></li>
                                            <li><a href="#">Оформлення</a></li>
                                            <li><a href="#">Зареєстровані</a></li>
                                            <li><a href="#">Надано</a></li>
                                            <li><a href="#">Надано до законопроекту</a></li>*}
                                            ...
                                            <li><a href="http://w1.c1.rada.gov.ua/pls/zweb2/webproc558">Повторно внесені (після доопрацювання)</a></li>
                                            <li><a href="http://w1.c1.rada.gov.ua/pls/site2/p_bills_stand_laws">Прийняті на поточній сесії</a></li>
                                            <li><a href="https://itd.rada.gov.ua/billInfo">Новий сайт «Законопроєкти»<sup style="color: #FAF2CC;">тест</sup></a></li>*}
                                            {*<li><a href="http://w1.c1.rada.gov.ua/pls/zweb2/webproc2">Пошук за реквізитами</a></li>
                                            <li><a href="https://zakon.rada.gov.ua/go/689-20,1165-20">Планування законопроектної роботи</a></li>
...
{*                                            <li><a href="http://w1.c1.rada.gov.ua/pls/zweb2/webproc2">Пошук за реквізитами</a></li>*}
                                    ...
                                    <div class="submenu_col divider_col">
                                        ...
                                        <ul>
{*                                            <li><a target="_blank" href="https://zakon.rada.gov.ua/rada/main/689-20,1165-20">Планування законопроектної роботи</a></li>*}
...
{*                                            <li><a href="https://zakon.rada.gov.ua/go/g22">Переклади актів acquis ЄС</a></li>*}
...
{*                                            <li><a href="https://zakon.rada.gov.ua/go/krym">Законодавство АР Крим</a></li>*}
                                           {* <p class="p_str">Законодавство АР Крим</p>*}
                                    ...
                                    <div class="submenu_col divider_col">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="https://zakon.rada.gov.ua/go/2912-20">Про деякі питання організації роботи Верховної Ради України дев'ятого скликання в умовах дії воєнного стану</a></li>
                                            ...
                                            <div class="submenu_table">
                                                <div class="submenu_row">
                                                    <div class="submenu_col">
                                                            ...
                                                            <h3><a href="/internactive">Міжнародна діяльність</a></h3><br>
...
{*                                                            <li><a href="/control_function">Контрольна діяльність</a></li> *}
                                                            {*<li><a href="/appointments">Призначення на посади</a></li>
                                                            <li><a href="/internactive">Міжнародна діяльність</a></li>
                                                            <li><a href="/gospfin">Фінансово-господарська діяльність</a></li> *}
                                                        </ul>
                                                    </div><!--/submenu_col-->
                                                </div><!--/submenu_row-->
                                            </div><!--/submenu_table-->
...
{*                                            <li><a href="/fba">Акредитація</a></li>*}
                                    ...
                                    <div class="submenu_col">
                                        ...
                                        <h3><a href="https://itd.rada.gov.ua/services/pubd">Громадське обговорення законопроектів</a></h3>
                                    ...
                                    <div class="submenu_col">
                                        ...
                                        <h3>Довідкова інформація для Апарату Верховної Ради України </h3>
                                        <ul>
                                            ...
                                            <li><a href="https://itdl.rada.gov.ua/apps/request">Електронна форма заявки ЗКТ</a></li>
...
{*                                       <h3><a href="/adminter_ustr">Адміністративно-територіальний устрій України</a></h3>  *}
{*                                       <ul>*}
{*                                            <li><a href="http://static.rada.gov.ua/zakon/new/NEWSAIT/ADM/zmist.html">Електронний довідник «Адміністративно-територіальний устрій України» (АТУУ)</a></li>                                            *}
{*                                        </ul> *}
                                    </div><!--/submenu_col-->
                                </div><!--/submenu_row-->
                            </div><!--/submenu_table-->
...
{*                        <a class="nav-link" href="/newscenter">Медіа-центр</a>*}
                    </li>
