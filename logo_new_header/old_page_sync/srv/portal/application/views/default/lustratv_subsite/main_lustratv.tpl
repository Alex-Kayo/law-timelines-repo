    ...
    <div class="row">
            <div class="col-md-3">
                <div class="contents-pages">
                    ...
                    <ul>
                        <li><a href="#menu1" class="scrollLink">Загальна інформація</a></li>
                        <li><a href="#menu2" class="scrollLink">Документи, якими керується Апарат Верховної Ради України при проведенні перевірки достовірності відомостей щодо застосування заборон передбачених положеннями Закону України «Про очищення влади»</a></li>
                        <li><a href="#menu3" class="scrollLink">Перелік посад та осіб, щодо яких проводиться перевірка</a></li>                      
                    </ul>
                </div>
            ...
            <div class="col-md-9">
                ...
                <ul class="link-list">
                    <li><a href="/documents/ochischenia_vlady/98904.html">Кандидати на посади</a></li>                    
                </ul>

                <h2 class="hub-page__heading">
                    <a id="menu2"></a>
                    Документи, якими керується Апарат Верховної Ради України при проведенні перевірки достовірності відомостей щодо застосування заборон передбачених положеннями Закону України «Про очищення влади»
                    <i class="link-ico"></i>
                </h2>
                <ul class="link-list">
                    <li><a href="/documents/ochischenia_vlady/98905.html">Перелік документів</a></li>                   
                </ul>
                ...
                <ul class="link-list">
                    <li><a href="/documents/ochischenia_vlady/98907.html">Перелік посад та осіб</a></li>                    
                </ul>
