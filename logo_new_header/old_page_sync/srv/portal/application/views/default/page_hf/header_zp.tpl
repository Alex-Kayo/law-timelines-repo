...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{$site_domain}sources/fonts/ProbaPro/stylesheet_remote.css" />
...
{*        <link rel="stylesheet" href="{$site_domain}sources/css/add-calendar-main.css">*}
        ...
        <link rel="stylesheet" type="text/css" href="{$site_domain}sources/css/style_remote.css" />
{*    ===================================================================================    *}
...
{*        <script src="{$site_domain}sources/js/jquery.jcarousel.min.js"></script>*}
            ...
            <div id="header">
                ...
                <div class="header_body">
                    ...
                    <div class="logo-main">
                        ...
                        <p style="position:absolute; left: 0px; right: 0px; top:0px;letter-spacing: 2px;">
                            <span style="display: inline-block; background: rgba(22,34,55,0.3); border-radius: 2px; padding: 0px 10px;">Сайт на етапі тестування</span>
                        </p>
...
{*                            <option>Русский</option>*}
                ...
                <nav id="navbar" class="navbar navbar-dark navbar-expand-lg">
                    <a class="navbar-brand" data-toggle="modal" data-target="#govModal">Верховна Рада України</a>
...
{*  ----------- MAin Page MENU ------------------------------------                      *}
                        {if !$items_munu_hide}
                            {include file= "page_hf/main_menu.tpl"} 
                        {else}
                            {include file= "page_hf/main_menu.tpl"}       
                        {/if} 
{*  ----------- End MAin Page MENU ------------------------------------                      *}                        
