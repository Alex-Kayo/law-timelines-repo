<div class="news-subsite__wrap" id="newscenter">
   <div class="news-subsite" style="background: #08255c;">
        <div class="publications-heading">
                <a href="/memorial">  Меморіал </a>
        </div>
...
{*<div class="collapse navbar-collapse" id="navbarSupportedContent3">
    <ul class="navbar-nav">*}
        ...
        {*<i id="acred"></i>
        <li  class="nav-item">
            <a class="nav-link" href="#acred">Меморіал</a>
        </li>
<li  class="nav-item">
            <a class="nav-link" href="/fba">Меморіал</a>
        </li>*}

        {*<li class="nav-item">
            <a class="nav-link" href="#faq">Меморіал</a>
        </li>*}
{*<li class="nav-item">*}
{*            <a class="nav-link" href="#p-s">Прес-служба</a>*}
{*        </li>*}
