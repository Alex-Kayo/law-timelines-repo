    ...
    <div class="container">       
        <div class="row">            
             <div class="col-lg-4 col-md-5">
                 {foreach item=data from=$block_data.13.items key=key name = i}  
{*                 {foreach item=data from=$top_news key=key name = i}  *}
                        
                {if $smarty.foreach.i.index == 0}
                   {* <div class="col-lg-6 col-md-12">*}
                        <div class="main-news" style="max-height: 280px;">
                            <img alt="" src="/uploads/logos/{$data->i_logoname}.jpeg" style="height: 280px; object-fit: unset;" >
                            <div class="main-news_heading">
...
<section  class="news-committee">
    ...
    <div class="container">
        ...
        <div class="more-link text-right">
            <a href="/{$block_data.6.topic->i_categories}">Архів новин комітетів</a>
        </div>
    </div>
</section>
<!-- /ALL THEME SCREEN 2 -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                ...
                <div class="more-link text-right">
                    <a href="/{$block_data.8.topic->i_categories}">Більше оглядів газети</a>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="more-link text-right">
                    <a href="/{$block_data.9.topic->i_categories}">Більше оглядів вісника</a>
                </div>
            </div><!--/col-lg-4-->
...
{*                 {foreach item=data from=$block_data.11.items}*}
                ...
                <div class="more-link text-right">
{*                    <a href="/{$block_data.11.topic->i_categories}">Більше оголошень</a>*}
                    <a href="/{$block_data.10.topic->i_categories}">Більше оголошень</a>
                </div>
            </div><!--/col-lg-4-->
...
{*<section class="media-library">
    ...
    <div class="container">
        <h2 class="block-heading">
            Фотобанк <a href="https://fotobank.rada.gov.ua" target="_blank">
        ...
        <div class="select-custom">
            ...
            <a href="https://www.youtube.com/user/RadaTVchannel" class="youtube-btn next-tab-link"></a>
            <hr class="light">
        ...
        <div class="tab-content" id="myTabContent">
            <div id="video" class="tab-pane fade show active" role="tabpanel" aria-labelledby="video-tab">
             ...
             <!-- video пример  -->                                                                                                     
                ...
                <div class="more-link text-right">
                    <a href="{$lang_prefix}/video"> Усі відеоматеріали</a>
                </div> 
            </div><!--/video tab -->
            ...
            <div id="photo" class="tab-pane fade" role="tabpanel" aria-labelledby="photo-tab">
                ...
                <div class="more-link text-right">
                    <a href="{$lang_prefix}/gallery">Усі фотоматеріали</a>
                </div>
            </div><!--/photo tab -->
        </div><!--/tab-content-->
