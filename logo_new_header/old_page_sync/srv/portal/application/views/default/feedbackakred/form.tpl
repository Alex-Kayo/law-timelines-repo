...
{*        <span class="warn">{$errors.eventname}</span>*}
        ...
        <div id="sel_info" class="text-agree">
            Для завершення процесу акредитації просимо Вас надіслати скани двох документів: першої та другої сторінки паспорту і прес-карти/редакційного посвідчення на електронну пошту <a href="mailto:advise@v.rada.gov.ua">advise@v.rada.gov.ua</a> до 16-00 дня, що передує обраній події.
        </div>
...
{*      {include file="feedbackakred/modal.tpl"}*}
