                    ...
                    <div class="tr-block">
                     <div class="td-block">
                        ...
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                  <a href="#"> Кошторис Верховної Ради Українина 2021 рік  </a>
                                </div>
                     ...
                     <div class="td-block">
                        ...
                        <ul class="hub-request__files">                                
                            <li style="background: none;">                                
                                <div>
                                    <a href="/documents/gosp_fin_dij_doc/inf_bd/203295.html">Інформація про бюджет за 2020 рік</a>
                                </div>
...
{*                    77777777777777777*}
                ...
                {*----------Динаміка - вивід новин депутатських груп з міжпарламентських зв’язків із зарубіжними країнами---------*}               
                    ...
                    {*{foreach item=data from=$block_data.6.items}*}
                    {foreach item=data from=$komnsecii_nd key=key name=i}
