<div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4">
                <div class="contents-pages">
                    ...
                    <ul>
                        ...
                        <li><a href="#menu2" class="scrollLink">Паспорти бюджетних програм</a></li>
                         <li><a href="#menu3" class="scrollLink">Оцінка ефективності бюджетної програми</a></li>
                        <li><a href="#menu4" class="scrollLink">Інформація про бюджет</a></li>
                        <li><a href="#menu5" class="scrollLink">Річні плани закупівель</a></li>
                        <li><a href="#menu6" class="scrollLink">Відкриті торги</a></li>
                        <li><a href="#menu7" class="scrollLink">Внутрішній аудит</a></li>
                        <li><a href="#menu8" class="scrollLink">Інформація про цілі державної політики</a></li>
                    </ul>
                </div>
            ...
            <div class="col-lg-9 col-md-8">
                ...
                <div class="row">
                    <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Оцінка ефективності за 2020 рік</div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="/uploads/documents/66471.pdf">Оцінка</a>
                                </div>
                                <span>Файл Portable Document Format, 16,61 МБайт</span>
                            </li>                            
                        </ul>
                    </div>
                    <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading"></div>
                    ...
                    <div class="show-prev-request col-lg-6">
                        <a href="#">Показати оцінки попередніх років</a>
                    </div>
                    <div class="more-link col-lg-6 text-right pt-0 pr-3">
                        <a href="/documents/gosp_fin_dij_doc/ocin_efect_prog/">Усі оцінки ефективності бюджетних програм</a>
                    </div>
                </div><!--/row-->
                ...
                <div class="row">
                    <div class="slice3 col-lg-4 col-md-6">
                         <div class="hub-request__heading">Інформація про бюджет за 2020 рік</div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="/uploads/documents/66814.pdf">Пояснювальна записка до звіту про виконання кошторису</a>
                                </div>
                                <span>Файл Portable Document Format, 0.09 МБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/66814.pdf">Додаток 6</a>
                                </div>
                                <span>Файл Portable Document Format, 45 КБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/66813.pdf">Додаток 5</a>
                                </div>
                                <span>Файл Portable Document Format, 19 КБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/66812.pdf">Додаток 4</a>
                                </div>
                                <span>Файл Portable Document Format, 46 КБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/66811.pdf">Додаток 3</a>
                                </div>
                                <span>Файл Portable Document Format, 19 КБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/66810.pdf">Додаток 2</a>
                                </div>
                                <span>Файл Portable Document Format, 45 КБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/66809.pdf">Додаток 1</a>
                                </div>
                                <span>Файл Portable Document Format, 19 КБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/66001.pdf">Публічний звіт</a>
                                </div>
                                <span>Файл Portable Document Format, 440 КБайт</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="slice3 col-lg-4 col-md-6">
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="/uploads/documents/61865.pdf">Інформація про бюджет за 2019 рік</a>
                                </div>
                                <span>Файл Portable Document Format, 480 КБайт</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="slice3 col-lg-4 col-md-6">
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="/uploads/documents/54472.pdf">Інформація про бюджет за 2018 рік</a>
                                </div>
                                <span>Файл Portable Document Format, 440 КБайт</span>
                            </li>
                        </ul>
                    ...
                    <div class="slice3 col-lg-4 col-md-6">
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="/uploads/documents/46793.pdf">Інформація про бюджет за 2017 рік</a>
                                </div>
                                <span>Файл Portable Document Format, 73 КБайт</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="slice3 col-lg-4 col-md-6">
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="/uploads/documents/43685.pdf">Інформація про бюджет за 2016 рік</a>
                                </div>
                                <span>Файл Portable Document Format, 71 КБайт</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="slice3 col-lg-4 col-md-6">
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="/uploads/documents/47520.pdf">Інформація про бюджет за 2015 рік</a>
                                </div>
                                <span>Файл Portable Document Format, 74 КБайт</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="slice3 col-lg-4 col-md-6">
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="/uploads/documents/47521.pdf">Інформація про бюджет за 2014 рік</a>
                                </div>
                                <span>Файл Portable Document Format, 76 КБайт</span>
                            </li>
                        </ul>
                    </div>
                    
                    <div class="show-prev-request col-lg-6">
                        <a href="#">Інформація попередніх років</a>
                    </div>
                    <div class="more-link col-lg-6 text-right pt-0 pr-3">
                        <a href="/documents/gosp_fin_dij_doc/inf_bd/">Уся інформація про бюджет</a>
                    </div>
                </div><!--/row-->
                ...
                <div class="row">
                    <div class="hub-page__block col-lg-6 pb-0">
                        <a id="menu5"></a>
                        <h2>Річні плани закупівель</h2>
                       {* <div style="background-color: #F5F5F5; height:230px; font-size: 38px; font-weight: bold; color: #ccc; text-align: center;padding-top: 7rem;">
                            HTML Banner
                        </div>*}
                        <div>
                            <img src="/img/banner-yearPlanBuy.jpg" class="img-fluid" alt="Річні плани закупівель" title="Річні плани закупівель" />
                        </div>
                        <ul class="hub-page__list">
                            <li>
                                {*<span class="date">14:02, 20 грудня 2018</span>*}
                                <div>
                                    <b><a href="/documents/gosp_fin_dij_doc/der_zak/">Державні закупівлі</a></b>
                                </div>
                                {*<div>
                                    <b><a href="/uploads/documents/46284.pdf">Річні плани закупівель на 2018 рік</a></b>
                                </div>*}
                            </li>                            
                        </ul>

                        <div class="more-link">
                            <a href="/documents/gosp_fin_dij_doc/der_zak/arh_derzhzak/">Архів планів закупівель</a>
                        </div>

                    </div>
                    <div class="hub-page__block col-lg-6 pb-0">
                        <a id="menu6"></a>
                        <h2>Відкриті торги</h2>
                        {*<div style="background-color: #F5F5F5; height:230px; font-size: 38px; font-weight: bold; color: #ccc; text-align: center;padding-top: 7rem;">
                            HTML Banner
                        </div>*}
                        <div>
                            <img src="/img/banner-openAuction.jpg" class="img-fluid" alt="Відкриті торги" title="Відкриті торги" />
                        </div>
                        <ul class="hub-page__list">
                            <li>
                                {*<span class="date">14:02, 20 грудня 2018</span>*}
                                <div>
                                    <b><a href="/documents/gosp_fin_dij_doc/der_zak/125074.html">Тендерна документація</a></b>
                                </div>
                            </li>                            
                        </ul>

                        <div class="more-link">
                            <a href="#">Архів тендерної документації</a>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="hub-page__block col-lg-6 pb-0">
                        <h2 class="hub-page__heading">
                            <a id="menu6"></a>
                            Оголошення конкурсу ДП "Парламентський телеканал "Рада"
                            <i class="link-ico"></i>
                        </h2>                                        
                        <ul class="hub-request__files">                                
                            <li>                                
                                <div>
                                    <a href="/uploads/documents/64974.pdf">Оголошення про результати проведення мистецького конкурсу</a>
                                </div>
                                <span>Файл Portable Document Format, 0.5 Mb</span>
                            </li>
                            <li>                                
                                <div>
                                    <a href="/uploads/documents/64881.doc">Оголошення</a>
                                </div>
                                <span>Файл Microsoft Word, 31 КБайт</span>
                            </li>
                            <li>                                
                                <div>
                                    <a href="/uploads/documents/64880.doc">Творче завдання</a>
                                </div>
                                <span>Файл Microsoft Word, 41 КБайт</span>
                            </li>
                            <li> 
                                <div>
                                    <a href="/uploads/documents/64879.doc">Перелік документів обов'язкових для подання</a>
                                </div>
                                <span>Файл Microsoft Word, 42 КБайт</span>                                
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/64878.doc">Положення про мистецький конкурс</a>
                                </div>
                                <span>Файл Microsoft Word, 62 КБайт</span>                               
                            </li>
                        </ul>
                        <div class="more-link">
                            <a href="/documents/gosp_fin_dij_doc/tv_channel_rada/198838.html">Уся інформація про конкурс</a>
                        </div>
                    </div>
                </div><!--/row-->
                ...
                <div class="row">
                    <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Цілі державної політики - 2020рік </div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="/uploads/documents/66699.pdf">Цілі</a>
                                </div>
                                <span>Файл Portable Document Format, 2,92 МБайт</span>
                            </li>                            
                        </ul>
                    </div>
                    <div class="slice3 col-lg-4 col-md-6">
                    ...
                    <div class="show-prev-request col-lg-6">
                        <a href="#">Показати цілі державної політики попередніх років</a>
                    </div>
                    <div class="more-link col-lg-6 text-right pt-0 pr-3">
                        <a href="/documents/gosp_fin_dij_doc/inf_pro_dersh_pol/">Усі цілі державної політики</a>
                    </div>
                </div><!--/row-->
