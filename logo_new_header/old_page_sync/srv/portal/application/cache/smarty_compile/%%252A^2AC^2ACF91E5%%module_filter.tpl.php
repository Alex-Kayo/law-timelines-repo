...
" <?php if ($this->_tpl_vars['search_params']['search_topic_id'] == $this->_tpl_vars['item']['t_id']): ?>SELECTED<?php endif; ?>><?php echo $this->_tpl_vars['item']['t_name']; ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="date_point_my"  value="<?php echo $this->_tpl_vars['search_params']['date_point_my']; ?>
" class="datepicker_my datepicker form-control" placeholder="Оберіть місяць та рік">
                </div>
