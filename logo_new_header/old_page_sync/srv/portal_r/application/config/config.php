...
$config['site_domain'] = '';
 ...
 //$config['back_ip'] = 'http://iadm.rada.gov.ua';
$config['back_ip'] = '192.168.7.18';
//$config['back_ip'] = 'iadm.rada.gov.ua';
// $config['site_domain'] = 'mportal.rada.gov.ua';
// $config['site_domain'] = 'iportal.rada.gov.ua';
/**
