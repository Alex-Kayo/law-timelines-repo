    ...
    <div id="head" >
      ...
      <div class="content-right0">
        ...
        <div id="searchbox">
          ...
          <a href="/search/" class="myrit">розширений пошук</a> </div>
        <div id="calend" class="clr qmrcorner"><a href="#" class="ybutton myrit" style="margin-top:-3px;"><span>архів »</span></a> <span style="margin-right:10px;" class="myriad"> {literal}
          <script type="text/javascript">
          <!--
    var now = new Date();
