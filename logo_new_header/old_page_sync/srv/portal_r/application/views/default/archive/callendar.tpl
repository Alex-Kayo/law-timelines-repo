		...
		{foreach item=data from=$days_list}
			<tr>
				{section name=day_index start=0 loop=7}
			      ...
			      <td {if ($selected_month*100+$num_day) eq $current_day}class="cur_day"{/if}>
				      {if $count_posts}
