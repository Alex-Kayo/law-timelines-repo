        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                    ...
                    *}
                    <div class="slice3 col-lg-4 col-md-6">
                        ...
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="/uploads/documents/52704.doc">Бюдзапит на 2021-2022 (c п 22)</a>
                                </div>
                                <span>Файл Rich Text Format, 319 КБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/52703.doc">Бюдзапит на 2020 рік </a>
                                </div>
                                <span>Файл Rich Text Format, 349 КБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/52702.doc">Бюджетний запит на 2020-2022 роки (Форма 2020-2)</a>
                                </div>
                                <span>Файл Microsoft Word, 769 KБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/52701.doc">Бюджетний запит на 2020-2022 роки (Форма 2020-1)</a>
                                </div>
                ...
                <h2 class="hub-page__heading">
                    ...
                    <div class="show-prev-request mb-5">
                        <a href="#">Інформація попередніх років</a>
                    </div>
                </div><!--/row-->
