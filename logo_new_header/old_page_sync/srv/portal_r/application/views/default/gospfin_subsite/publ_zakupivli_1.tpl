                        ...
                        {*<div class="excursion_b size-m">
                         ...
                         <div class="excursion_b size-m" style="background: url('/img/logo_prozorrosale.svg') center center no-repeat;  background-size: contain; max-width: 90%;">
                            <div class="excursion-heading"> </div>
                             ...
                             <a href="https://prozorro.sale/auction/search" class="link" title=" Перейти за посиланням на офіційний веб-сайт Prozorro.sale" target="_blank" rel="noopener noreferrer" style="position: relative;{*margin-top: 5.5em;*}color: #0f0d2d;top: 3.0em;left:5.3em;font-weight: bold;"> Детальніше  <i class="icn-external"></i> </a>
                        </div> 
