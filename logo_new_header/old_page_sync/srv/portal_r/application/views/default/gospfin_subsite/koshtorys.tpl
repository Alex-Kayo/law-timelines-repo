...
<div class="container" style="padding-left: 1rem;padding-right: 1rem;">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Виконання кошторису</a></li>
        </ol>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4">
                <div class="contents-pages">
                    ...
                    <ul>
                        <li><a href="#menu1" class="scrollLink">Інформація про кошторис</a></li>
                        <li><a href="#menu2" class="scrollLink">Звіти про виконання паспортів бюджетних програм</a></li>
                        <li><a href="#menu3" class="scrollLink">Оцінка ефективності бюджетних програм</a></li>
                        <li><a href="#menu4" class="scrollLink">Інформація про цілі державної політики</a></li>
                        <li><a href="#menu5" class="scrollLink">Інформація про компенсацію народним депутатам України вартості оренди житла або винайму готельного номера</a></li>
                        <li><a href="#menu6" class="scrollLink">Звітність</a></li>
            ...
            <div class="col-lg-9 col-md-8">
                {*<h2 class="hub-page__heading">
                    <a id="menu1"></a>
                    Інформація про кошторис
                    <i class="link-ico"></i>
                </h2>*}
{*               77777777777777777*}
                 <div class="row">
                    <div class="hub-page__block col-lg-6 pb-0" style="padding-top: 0rem;">
                        <h2 class="hub-page__heading">
                            <a id="menu1" style="padding-top: 12rem;margin-top: -10rem;"></a>
{*                           <span id="audit" class="anchor-section"></span>*}
                            Кошторис Верховної Ради України 
                            <i class="link-ico"></i>
                        </h2>
                        <div class="hub-request__heading"> {*Кошторис Верховної Ради України*} </div>  
                        <ul class="link-list">
                    <div class="tr-block">
                     <div class="td-block">
                        <div class="more-link full-bg">
                            <a {*id="menu2"*}  href="/documents/gosp_fin_dij_doc/koshtorysy_vytrat_doc/koshtorys_VRU"> Відомості про Кошторис  </a>
                        </div>
                    </div>
                     </div>
                </ul>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                  <a href="/documents/gosp_fin_dij_doc/koshtorysy_vytrat_doc/koshtorys_VRU/243697.html"> Кошторис Верховної Ради України на 2024 рік  </a>
                                </div>
                                <span>Файл Portable Document Format, {*2.31 Mb*}</span>
                            </li>
                            <li>
                                <div>
                                  <a href="/documents/gosp_fin_dij_doc/koshtorysy_vytrat_doc/koshtorys_VRU/230777.html"> Кошторис Верховної Ради України на 2023 рік  </a>
                                </div>
                                <span>Файл Portable Document Format, {*2.31 Mb*}</span>
                            </li>
                            <li>
                                <div>
                                  <a href="/documents/gosp_fin_dij_doc/koshtorysy_vytrat_doc/koshtorys_VRU/219952.html"> Кошторис Верховної Ради України на 2022 рік  </a>
{*                                  <a href="/documents/gosp_fin_dij_doc/inf_bd/203295.html"> Кошторис Верховної Ради України на 2020 рік  </a>*}
                                </div>
                        ...
                        <div class="more-link">
                            <a href="/documents/gosp_fin_dij_doc/koshtorysy_vytrat_doc/koshtorys_VRU">Уся інформація розділу</a>
                        </div>
                    </div>                        
                    <div class="hub-page__block col-lg-6 pb-0" style="padding-top: 0rem;">
                        <h2 class="hub-page__heading">
{*                            <a id="menu1"></a>*}
                           Інформація про виконання кошторису  за попередні роки
                            <i class="link-ico"></i>
                        </h2> 
                        <ul class="link-list">
                    <div class="tr-block">
                     <div class="td-block">
                        <div class="more-link full-bg">
                            <a {*id="menu2"*}  href="/documents/gosp_fin_dij_doc/koshtorysy_vytrat_doc/koshtorys_archive"> Відомості за попередні роки  </a>
                        </div>
                    </div>
                     </div>
                </ul>
                        <ul class="hub-request__files"> 
                            <li style="background: none;">                                
                                <div>
                                    <a href="/documents/gosp_fin_dij_doc/koshtorysy_vytrat_doc/koshtorys_archive/234007.html">Звіт про виконання кошторису за 2022 рік</a>
                                </div>
                                {*<span>Файл Microsoft Word, 31 КБайт</span>*}
                            </li>
                            <li style="background: none;">                                
                                <div>
                                    <a href="/documents/gosp_fin_dij_doc/koshtorysy_vytrat_doc/koshtorys_archive/219954.html">Звіт про виконання кошторису за 2021 рік</a>
                                </div>
                                {*<span>Файл Microsoft Word, 31 КБайт</span>*}
                            </li>
                            <li style="background: none;">                                
                                <div>
                                    <a href="/documents/gosp_fin_dij_doc/inf_bd/203295.html">Звіт про виконання кошторису за 2020 рік</a>
                                </div>
                                {*<span>Файл Microsoft Word, 31 КБайт</span>*}
                            </li>
                            ...
                            {*<li style="background: none;">                                
                                <div>
                                    <a href="/documents/gosp_fin_dij_doc/inf_bd/189843.html">Інформація про бюджет за 2019 рік</a>
                                </div>
                                <span>Файл Microsoft Word, 41 КБайт</span>
                            </li>*}
                            {*<li style="background: none;"> 
                                <div>
                                    <a href="/documents/gosp_fin_dij_doc/inf_bd/167150.html">Інформація про бюджет за 2018 рік</a>
                                </div>
                                <span>Файл Microsoft Word, 42 КБайт</span>                               
                            </li>*}
                             
                        </ul>
                        <div class="more-link text-right">
{*                            <a href="/documents/gosp_fin_dij_doc/inf_bd/">Уся інформація розділу</a>*}
                            <a href="/documents/gosp_fin_dij_doc/koshtorysy_vytrat_doc/koshtorys_archive">Уся інформація розділу</a>
                        </div>
                    </div>
                </div><!--/row-->
...
{*               77777777777777777*}
                ...
                <div class="row">
                   ...
                   <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Звіти про виконання паспортів бюджетних програм на 2022 рік</div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="/uploads/documents/74103.pdf">Звіт про виконання паспорта за КПКВК 0111010 на 2022 рік</a>
                                </div>
                                <span>Файл Portable Document Format, 0,4 МБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/74102.pdf">Звіт про виконання паспорта за КПКВК 0111020 на 2022 рік</a>
                                </div>
                                <span>Файл Portable Document Format, 0,4 МБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/74101.pdf">Звіт про виконання паспорта за КПКВК 0111090 на 2022 рік</a>
                                </div>
                                <span>Файл Portable Document Format, 0,4 МБайт</span>
                            </li>
                            ...
                            {*<li>
                                <div>
                                    <a href="/uploads/documents/72929.pdf"> Паспорт на 2022 рік за КПКВК 0111020 </a>
                                </div>
                                <span>Файл Portable Document Format, 2,28 МБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/72928.pdf"> Паспорт на 2022 рік за КПКВК 0111010</a>
                                </div>
                                <span>Файл Portable Document Format, 2,94 МБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/72815.pdf">  Паспорт на 2022 рік за КПКВК 0111090</a>
                                </div>
                    ...
                    <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Звіти про виконання паспортів бюджетних програм на 2021 рік</div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="/uploads/documents/72971.doc">    Звіт про виконання паспорта за КПКВК 0111090 на 2021 рік</a>
                                </div>
                                <span>Файл Microsoft Word, 0,1 МБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/72970.doc">   Звіт про виконання паспорта за КПКВК 0111020 на 2021 рік</a>
                                </div>
                                <span>Файл Microsoft Word, 0,16 МБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="/uploads/documents/72969.doc">  Звіт про виконання паспорта за КПКВК 0111010 на 2021рік</a>
                                </div>
                                <span>Файл Microsoft Word, 0,17 МБайт</span>
                            </li>
                            {*<li>
                                <div>
                        ...
                        <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Звіти про виконання паспортів бюджетних програм на 2020 рік</div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                    ...
                    <div class="show-prev-request col-lg-6">
                        <a href="#">Показати звіти попередніх років</a>
                    </div>
                    <div class="more-link col-lg-6 text-right pt-0 pr-3">
                        <a href="/documents/gosp_fin_dij_doc/p_bd_pr/">Усі паспорти  бюджетних програм (звіти)</a>
                    </div>
                </div><!--/row-->
...
{*                    {foreach item=data from=$effectiv_bdProg}*}
                  {foreach item=data from=$ocin_efect_prog}
                 ...
                 <h2 class="hub-page__heading">
                    ...
                    Інформація про цілі державної політики
                    <i class="link-ico"></i>
                </h2>
                <ul class="link-list">
                ...
                {*----------Динаміка - вивід новин депутатських груп з міжпарламентських зв’язків із зарубіжними країнами---------*}               
                    ...
                    {*{foreach item=data from=$block_data.6.items}*}
{*                    {foreach item=data from=$publ_policyGoals}*}
                    {foreach item=data from=$inf_pro_dersh_pol}
                        <div class="  col-lg-4  col-md-6   ">
...
{*                    77777777777777777*}
                 ...
                 <h2 class="hub-page__heading">
                    <a id="menu5" style="padding-top: 12rem;margin-top: -10rem;"></a>
                    Інформація про компенсацію народним депутатам України вартості оренди житла або винайму готельного номера
                    <i class="link-ico"></i>
                </h2>
                <ul class="link-list">
                ...
                {*----------Динаміка - вивід новин депутатських груп з міжпарламентських зв’язків із зарубіжними країнами---------*}               
                    ...
                    {*{foreach item=data from=$block_data.6.items}*}
                    {foreach item=data from=$komnsecii_nd }
             ...
             <div class="row">
                    <div class="hub-page__block col-lg-6 pb-0" style="padding-top: 0rem;">
                        <h2 class="hub-page__heading">
                            <a id="menu6" style="padding-top: 12rem; margin-top: -8rem;"></a>
{*                           <span id="audit" class="anchor-section"></span>*}
                           Звітність
                            <i class="link-ico"></i>
                        </h2>
                    ...
                    <div class="tr-block">
                     <div class="td-block">
                        <div class="more-link full-bg">
                            <a {*id="menu2"*}  href="/documents/gosp_fin_dij_doc/financial_statements"> Річна консолідована фінансова звітність  </a>
                        </div>
                    </div>
                     </div>
                </ul>
                        {*<ul class="hub-request__files">
                            <li>
                                <div>
                                  <a href="#!">Річна  фінансова звітність за 2020 рік  </a>
                                </div>
                                <span>Файл Portable Document Format, 2.29 Mb</span>
                            </li>
                        ...
                        {*<div class="more-link">
                            <a href="/documents/gosp_fin_dij_doc/financial_statements/">Уся інформація розділу</a>
                        </div>*}
                    </div>                        
                </div><!--/row-->
                
                {*----------  вивід  річна  фінансова звітність ---------*}               
            <ul class="link-list">
                    ...
                    {foreach item=data from=$zvity_fin_year }
                        {if $smarty.foreach.i.index < 6}
                        <div class="  col-lg-4  col-md-6   ">
                             
                            <div class="news-item">
                                 <span class="date">{$data->day}&nbsp;{$data->month}&nbsp;{$data->year};{$data->hour}</span>
                                 <div class="hub-request__heading"  style="font-size: 1rem;">
                            <a href="{$lang_prefix}/{$data->i_categories}/{$data->i_id}.html">
                                 {$data->i_name}
                            </a>
                                 </div>
