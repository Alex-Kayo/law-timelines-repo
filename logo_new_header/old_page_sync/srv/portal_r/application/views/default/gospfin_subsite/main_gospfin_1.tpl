<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                ...
                <div class="row">
                    {*----Динаміка виводу списку (років) бюджетних запитів---------*}
                        ...
                        <div class="slice3 col-lg-4 col-md-6">
                            <div class="hub-request__heading"><a href="{$lang_prefix}/{$data->i_categories}/{$data->i_id}.html">{$data->i_name}</a></div>
                                <ul class="hub-request__files">
                                    {*----Динаміка виводу списку бюджетних запитів одного року---------*}
                                    <li>
                                        <div>
                    ...
                    {*
                    <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Запити за 2019 рік</div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="/uploads/documents/52704.doc">Бюджетний запит 2019-3.2</a>
                    ...
                    <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Запити за 2018 рік</div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                    ...
                    <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Запити за 2017 рік</div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                    ...
                    {*
                    <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Запити за 2016 рік</div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                                    <a href="#">Бюджетний запит 2016-2</a>
                                </div>
                                <span>Файл Rich Text Format, 2,5 МБайт</span>
                            </li>
                            <li>
                                <div>
                                    <a href="#">Бюджетний запит 2016</a>
                                </div>
                                <span>Файл Rich Text Format, 2,5 МБайт</span>
                            </li>
                        </ul>
                ...
                <div class="row">
                    <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Паспорти за 2019 рік</div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                    ...
                    <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Паспорти за 2018 рік</div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                    ...
                    <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Паспорти за 2017 рік</div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                    ...
                    <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Паспорти за 2016 рік</div>
                        <ul class="hub-request__files">
                            <li>
                                <div>
                    ...
                    <div class="slice3 col-lg-4 col-md-6">
                        <div class="hub-request__heading">Паспорти за 2015 рік</div>
                        <ul class="hub-request__files">                            
                            <li>
                                <div>
                ...
                <div class="row">
                    <div class="hub-page__block col-lg-6">
                        <a id="menu4"></a>
                        ...
                        <ul class="hub-page__list">
                            ...
                            <li>
                                {*<span class="date">14:02, 20 грудня 2018</span>*}
                                <div>
                                    <a href="/uploads/documents/39886.pdf">Річні плани закупівель на 2017 рік</a>
                                </div>
                            </li>
                            <li>
                                {*<span class="date">14:02, 20 грудня 2018</span>*}
                                <div>
                                    <a href="/documents/gosp_fin_dij_doc/der_zak/arh_derzhzak/124311.html">Річні плани закупівель на 2016 рік</a>
                                </div>
                            </li>
                        </ul>

                        <div class="more-link">
                            <a href="#">Архів планів закупівель</a>
                        </div>
