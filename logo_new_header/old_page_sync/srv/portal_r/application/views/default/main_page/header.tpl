    ...
    <div id="mainhead" class="header_body">
        ...
        <div class="services">
            ...
            <div class="lang_block_new services-block">
                <div class="dropdown">
                    <button id="lang_menu_logo" class="btn btn-primary dropdown-toggle with-caret services-line opaque" type="button"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="search_block">
                <form method="get" action="/search">
                    <button type="submit" class="search_button opaque">
                    <i class="fa fa-search"></i><span class="search_button_text">Пошук</span>
                    </button>
                </form>
            </div>
            <div class="lang_block_new services-block">
                <div class="dropdown">
                    <button id="lang_menu_navbar_sticky" class="btn btn-primary dropdown-toggle with-caret" type="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
