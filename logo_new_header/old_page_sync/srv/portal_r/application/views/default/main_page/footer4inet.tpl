...
{*                            </select>*}
                    ...
                    <div class="col-lg-8 col-md-6">
                        <ul class="social-footer">
                            ...
                            {*<li>
                                <a class="youtube-ico" href="https://www.youtube.com/channel/UCT_QirupNzM7h2EMypxuIxw" target="_blank">
                                    <i class="fab fa-youtube"></i>
                                    Ютьюб
                                </a>
                            </li>*}
                             <li>
                                <a class="youtube-ico" href="https://www.youtube.com/channel/UC5V8mErVFOpcQXEb3y9IMZw" target="_blank">
                                    <i class="fab fa-youtube"></i>
                                    Ютьюб
                                </a>
                            </li>
                            ...
                            <li>
                                    <a class="telegram-ico" href="https://t.me/verkhovnaradaofukrainy" target="_blank">
...
{*                            <li><a href="http://euinfocenter.rada.gov.ua/" target="_blank">Інформаційно-дослідницький центр</a></li>*}
...
{*                                <a href="https://play.google.com/store/apps/details?id=com.oshkolacompany.rada" target="_blank"><img alt="" src="/img/GooglePlay_black.png" /></a></li>*}
{*                            </div>*}
{*                            <div class="col-12 col-sm-6 col-md-12 col-lg-6">*}
{*                                <a href="https://apps.apple.com/ua/app/%D0%B2%D0%B5%D1%80%D1%85%D0%BE%D0%B2%D0%BD%D0%B0-%D1%80%D0%B0%D0%B4%D0%B0/id1588267563?l=ru" target="_blank"><img alt="" src="/img/AppStore_black.png" /></a></li>*}
{*                            </div>*}
{*                        </div>*}
                        
                        {*<ul class="column-2-list" style="padding-bottom: 0;">
                            <li><a href="#" target="_blank"><img alt="" src="/img/GooglePlay_black.png" /></a></li>*}
                            {*<li><a href="#" target="_blank"><img alt="" src="/img/GooglePlay_bluel.png" /></a></li>*}
                            {*<li><a href="#" target="_blank"><img alt="" src="/img/AppStore_black.png" /></a></li>     *}                    
                            {*<li><a href="#" target="_blank"><img alt="" src="/img/AppStore_bluel.png" /></a></li>*}
                       {* </ul>  *}                     
    ...
    <path d="M12,2 C17.514,2 22,6.486 22,12 C22,17.514 17.514,22 12,22 L12,20 C16.411,20 20,16.411 20,12 C20,7.589 16.411,4 12,4 C7.589,4 4,7.589 4,12 C4,14.885 5.528,17.478 8,18.908 L8,16 C8,15.448 8.448,15 9,15 C9.552,15 10,15.448 10,16 L10,21 C10,21.552 9.552,22 9,22 L4,22 C3.448,22 3,21.552 3,21 C3,20.448 3.448,20 4,20 L6.026,20 C3.515,18.133 2,15.211 2,12 C2,6.486 6.486,2 12,2 Z M16,13 L12,13 C11.448,13 11,12.552 11,12 L11,6 L13,6 L13,11 L16,11 L16,13 Z" id="Fill-2">
                        ...
                        <a href="https://iportal.rada.gov.ua" target="_blank" style="margin-top: 13px">Попередня версія сайту</a>*}
                        ...
                        <p>Iнформаційна підтримка — <a href="http://w1.c1.rada.gov.ua/pls/site2/p_pidrozdil2?pidid=1292">Інформаційне управління,</a><a href="http://w1.c1.rada.gov.ua/pls/site2/p_pidrozdil2?pidid=3263"> Прес-служба Апарату Верховної Ради України</a></p>
                        ...
                        <div class="kitsoft-block">
                            ...
                            <p class="copy">&copy; Верховна Рада України 1994—{$smarty.now|date_format:"%Y"}</p>
    </div>
</div>
