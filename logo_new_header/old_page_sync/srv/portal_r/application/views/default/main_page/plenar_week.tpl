...
{*        <h2 class="block-heading">Пленарне засідання</h2>  *}

{* Для позачаргового заремлюєм  *}
      <h2 class="block-heading">Пленарний тиждень</h2>
{*		<h2 class="block-heading">Пленарне засідання</h2>*}
         <h5 class="block-heading__date"> з {$planar_week_dates->day_s}  {$planar_week_dates->mon_s} {$planar_week_dates->year_s} року по {$planar_week_dates->day_e} {$planar_week_dates->mon_e} {$planar_week_dates->year_e} року</h5>

{*		          <h5 class="block-heading__date">1  лютого {$planar_week_dates->year_s} року*}

            
{*        <h5 class="block-heading__date"> 1 вересня {$planar_week_dates->year_s}  року</h5>*}
{*        <h5 class="block-heading__date"> {$planar_week_dates->day_s} {$planar_week_dates->mon_s} {$planar_week_dates->year_s}  року</h5>*}
        
        
        
        {*<h5 class="block-heading__date"> з {$planar_week_dates->day_s} {$planar_week_dates->mon_s} {$planar_week_dates->year_s} по {$planar_week_dates->day_e} {$planar_week_dates->mon_e} {$planar_week_dates->year_e} року</h5>*}
        
        <br>
        <span class="more-link black-link">
                                        <a href="/meeting/awt">Питання порядків денних, запланованих до розгляду на пленарних засіданнях&nbsp;&nbsp;</a>
...
{*                         <div class="tab-pane fade active show" id="pw_day_{$data.day}" role="tabpanel" aria-labelledby="main-tab">*}
                        ...
                        <div class="tab-pane fade {$data.status} show" id="pw_day_{$data.day}" role="tabpanel" aria-labelledby="main-tab">
                            ...
                            <div class="polling-tabs">
                                ...
                                Поки що не відбулось жодного голосування…
                            </div>
...
{*                                    {$smarty.foreach.k.index}*}
                                            ...
                                            {if $data.item}<div class="more-link text-right"><a href="/news/hpz9">Попередні голосування</a></div>{/if}
...
{*                    {if 1} {*погоджувальна рада*}
                    ...
                    <div class="rada-tv">
                        <div class="rada-tv__video">
                            ...
                            <a href="https://www.rada.gov.ua/video/rada-tv/64430.html" class="play-btn"></a>
...
{*                        <a href="/video/rada-tv/64430.html" class="watch-online__link">Дивитись онлайн</a>*}
                    </div>
                </div>
                    </div>
                    ...
                    <a class="electronic-registration_heading" href="{$planar_registratios->link}">Електронна реєстрація народних депутатів  на початок засідання</a>
...
{/literal}
                        ...
                        {/if}
                        <div class="more-link text-right"><a href="/news/Rstr_nd_9">Переглянути інші реєстрації</a></div>
{*                        <div class="more-link text-right"><a href="/news/Rstr_nd_9">Реєстрація в інші пленарні дні</a></div>*}
...
{*                    <hr>*}
                    ...
                    <ul class="ul-list with-ico">
                        <li class="icn-transcript"><a href="/meeting/stenpog"> Стенограми погоджувальних рад</a></li>
                        <li class="icn-table"><a href="http://w1.c1.rada.gov.ua/pls/prada/ns_el_h"> Електронний протокол</a></li>       
                    </ul>
                </div>
                    </div>
                       {/if} 
