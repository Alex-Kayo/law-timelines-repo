                    ...
                    {foreach item=data from=$attachments}
                        ...
                        {foreach item=doc from=$data}                                        
                            <li>
                                ...
                                <a title="Переглянути" href="/uploads/documents/{$doc->ia_id}.{$doc->ia_type}" class="to-look">
                                    <i class="far fa-eye"></i>
                                    Переглянути
                                </a>
                                    <a href="/uploads/documents/{$doc->ia_id}.{$doc->ia_type}" title="Завантажити" class="download-link" download></a>
                            </li>   
...
{*                    <span class="social-aside-stop"></span>*}
               {* <div class="aside-column col-md-3">
                    <div class="section-heading">
                        <span>Ще за розділом</span>  <br> 
                        <h4> {$current_node->t_name}  </h4>   </div>
