{if $is_news_subsite}
   ...
   {elseif $is_nato_subsite}
   {include file='nato_subsite/nato_menu.tpl'}
{/if}
...
{*                                {$data->is_video|@var_dump}*}
                            ...
                            {if $data->i_anons}
                                <p>{$data->i_anons}</p>
                            {/if}
                              {*<a href="{$lang_prefix}/{$data->i_categories}/{$data->i_id}.html" class="tags">докладніше </a>*}
