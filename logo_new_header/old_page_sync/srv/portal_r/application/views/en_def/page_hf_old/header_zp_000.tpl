        ...
        <div id="page">
            ...
            <div id="header">
                ...
                <div class="lang_block">
                    ...
                    <ul class="map_menu">
                        <li><a href="{$lang_prefix}{$site_domain}/rss/news">RSS</a></li>
                            {*       <li><a href="#">архiв</a><input type="text" class="archive_date" /></li> *}
                        <li><a href="{$lang_prefix}{$site_domain}/archive/">архiв</a></li>
                        <li><a href="{$lang_prefix}{$site_domain}/map/">мапа сайту</a></li>
                    </ul>                
                ...
                <div class="header_body">
                    ...
                    <div class="search_block">
                        ...
                        <form method="get" action="{$lang_prefix}{$site_domain}/search_out">
                            <input type="submit" class="search_button" value="Пошук"  name="search"/><input type="text" class="search_input"  name="submit" />
                        </form>                 

                        <a class="wide_search" href="{$lang_prefix}{$site_domain}/search/">розширений пошук</a>
                    </div>
                </div>
                <!-- end main header -->
                <!--	{$RequestorIp}	-->
