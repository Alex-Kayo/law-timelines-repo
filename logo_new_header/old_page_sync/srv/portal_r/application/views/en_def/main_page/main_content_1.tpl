...
{*                                Наступні події цього дня*}
    ...
    <div class="more-link">
        <a href="/preview/">Усі анонсовані події</a>
    </div>
    </div>
</section>
    ...
    <div class="row">
        <div class="col-lg-6 col-sm-12">
            <div class="request-online__block">
                ...
                <div class="request-online__text mob-hide">Станьте свідком роботи парламенту країни — подайте заяву на відвідання пленарного засідання онлайн!</div>
...
{*                                    <a href="#" class="btn-video">Відео</a>*}
                ...
                <div class="col-lg-4 col-sm-12">
                    ...
                    {foreach item=data from=$logo_news key=key name=i} 
                        {if $smarty.foreach.i.index > 1 && $smarty.foreach.i.index < 6}
...
<div class="select-custom">
    ...
    <a href="http://w1.c1.rada.gov.ua/pls/zweb2/webproc2" class="search-by-link">Пошук <span class="tab-hide">за реквізитами</span></a>
...
<div class="select-custom">
    ...
    <a href="https://zakon.rada.gov.ua/rada/main/a#Find" class="search-by-link">Пошук <span class="tab-hide">за реквізитами</span></a>
    <hr class="light">
</div>
...
{*                            <span class="btn-border">Соціальна політика</span>*}
                ...
                <div class="col-md-4 col-sm-12">
                    <ul class="gerb-list">
                                <li><a target ="_blank" href="https://zakon.rada.gov.ua/rada/show/254%D0%BA/96-%D0%B2%D1%80">Конституція України</a></li>
                                <li><a target ="_blank" href="https://zakon.rada.gov.ua/rada/main/t21">Кодекси України</a></li>
                                <li><a target ="_blank" href="https://zakon.rada.gov.ua/rada/main/tt1001">Закони України</a></li>
                    </ul>
                    <ul class="ul-list">
                                <li><a target ="_blank" href="https://zakon.rada.gov.ua/rada/main/country">Міжнародні документи <i class="icn-chevron-right"></i></a></li>
                                <li><a target ="_blank" href="https://www.kmu.gov.ua/ua/diyalnist/yevropejska-integraciya/perekladi-aktiv-acquis-yes">Переклади актів acquis ЄС <i class="icn-external"></i></a></li>
                                <li><a target ="_blank" href="https://zakon.rada.gov.ua/rada/main/perv">Первинні законодавчі акти <i class="icn-chevron-right"></i></a></li>
                                <li><a target ="_blank" href="https://zakon.rada.gov.ua/rada/main/koms">Розподіл прийнятих законодавчих актів за комітетами Верховної Ради <i class="icn-chevron-right"></i></a></li>
                                <li><a target ="_blank" href="https://zakon.rada.gov.ua/rada/main/annot">Анотації англійською мовою <i class="icn-chevron-right"></i></a></li>
                                <li><a target ="_blank" href="https://zakon.rada.gov.ua/rada/term">Термінологія законодавства <i class="icn-chevron-right"></i></a></li>
                                <li><a target ="_blank" href="https://zakon.rada.gov.ua/rada/main/klas">Юридична кваліфікація<i class="icn-chevron-right"></i> </a></li>
                                <li><a target ="_blank" href="https://zakon.rada.gov.ua/rada/main/days">Календар офіційних дат <i class="icn-chevron-right"></i></a></li>
                    </ul>
                </div>
            </div>
