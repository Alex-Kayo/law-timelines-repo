...
<div class="page-heading">
    ...
    <h3>
        {if $current_node->t_name != "All publications (EN)"}
        {$current_node->t_name}
        {else} 
        All publications
        {/if}    
...
{*                            <div class="timeline-block__label">Новина</div>*}
                            ...
                            <div class="timeline-block__heading f-bold">
                                <a href="{$lang_prefix}/{$data->i_categories}/{$data->i_id}.html">  {*//javir*}
                                    {$data->i_name}
                                </a>
                            ...
                            {/if}
                            <!--<span class="details">
                                <a href="{*{$lang_prefix}*}/{$data->i_categories}/{$data->i_id}.html">In greater detail </a> //javir
                            </span>-->
    ...
    <!-- col-md-3 -->
          {*  <div class="col-md-3">
               ...
               <div class="col-md-3 right-column-content">
                   <div class="section-heading">Topic of great moment:</div>
...
{foreach item=data from=$block_data.5.items} 
              ...
              <div class="section-heading"> <a href="{$lang_prefix}/{$data->i_categories}">To review more</a></div>
                ...
                <div class="full-mob-width">
                    <div class="digest-section digest-small">
                        <div class="content">
                            ...
                            <p>Be in direct receipt of VRU web portal’s highlights at your mailbox</p>
                            ...
                            <form method="post" action="{$lang_prefix}/subscribe/index">
                                ...
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-white" type="submit">Setting</button>
