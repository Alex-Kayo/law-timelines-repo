                        ...
                        <!-- /advanced request -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check display-inline">
                                            ...
                                            <input class="form-check-input" type="radio" name="date_type" id="exampleRadios6" value="1" checked >
                                        ...
                                        <div class="form-check display-inline">    
                                            ...
                                            <input class="form-check-input" type="radio" name="date_type" id="exampleRadios6" value="2" >
                                            <label class="form-check-label" for="date_type1">
                                                Earlier than
                                            </label>
                                        </div>
                                        <div class="form-check display-inline">
                                            <input class="form-check-input" type="radio" name="date_type" id="exampleRadios6" value="3">
                                        ...
                                        <input type="text" name="date_point" class="en-datepicker form-control" placeholder="If necessary, select a date">
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sort" id="exampleRadios5" value="1" >
