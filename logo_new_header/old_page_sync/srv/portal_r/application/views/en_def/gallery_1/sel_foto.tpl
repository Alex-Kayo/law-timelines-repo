...
<div class="photo-list">
    ...
    {*{foreach item=imgs from=$images name=i}
    {if $smarty.foreach.i.index <= 6} 
    <a href="javascript://" data-toggle="modal" data-target="#photoModal">
    <img alt="" src="/uploads/gallery/{$imgs.items.filename}" />
    </a>
    {/if}
    {/foreach}*}
    {*<a href="javascript://" data-toggle="modal" data-target="#photoModal"><img alt="" src="/uploads/gallery/54709.jpeg" /></a>
    <a href="javascript://" data-toggle="modal" data-target="#photoModal"><img alt="" src="/uploads/gallery/54709.jpeg" /></a>
    <a href="javascript://" data-toggle="modal" data-target="#photoModal"><img alt="" src="/uploads/gallery/54709.jpeg" /></a>
    <a href="javascript://" data-toggle="modal" data-target="#photoModal"><img alt="" src="/uploads/gallery/54709.jpeg" /></a>*}
    {foreach item=imgs from=$images.items name=i}
        {if $smarty.foreach.i.index < 18}
            <a href="javascript://" data-toggle="modal" data-target="#photoModal">
                <img alt="" src="/uploads/gallery_prev/{$imgs.filename}" /></a>
            {/if}
        {/foreach}
