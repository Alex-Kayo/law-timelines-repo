...
uploads/logos_middle/<?php echo $this->_tpl_vars['item']->i_logoname; ?>
.jpeg
      <?php else: ?> www.rada.gov.ua/img/rada-logo.png
      <?php endif; ?>" />
    ...
    <body>
        <div id="page">
                    ...
                    <div class="logo-main">
                        ...
                        <p>Офіційний вебпортал парламенту України <br> <i><b>&nbsp;</b></i></p>
...
<div id="cab_grom">
    ...
    <a href="/video/rada-tv/64430.html" class="rada-tv__label hide-select">
        <b>RADA &nbsp;</b>ОНЛАЙН</a>
    </div>
...
unset($_smarty_tpl_vars);
 ?>
            <?php else: ?>
                <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "main_page/footer4inet.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
            <?php endif; ?>
