<?php /* Smarty version 2.6.22, created on 2024-01-31 11:14:41
         compiled from preview/module_filter.tpl */ ?>
...
" <?php if ($this->_tpl_vars['search_params']['search_topic_id'] == $this->_tpl_vars['item']['t_id']): ?>SELECTED<?php endif; ?>><?php echo $this->_tpl_vars['item']['t_name']; ?>
                ...
                <div class="form-group">
                    <label>Пошук за датою</label>
                    
                    <input type="text" name="date_point" value="<?php echo $this->_tpl_vars['date_search']; ?>
" class="datepicker form-control" placeholder="Оберіть дату">
                </div>
...
" name="search_substr" id="search_substr"/>
                ...
                <div class="form-group">
                    ...
                    <input type="submit" class="btn btn-yellow gallerysearch_but" value="Пошук" name="submit">
                </div>
            </div>
                </div>
            </form>
