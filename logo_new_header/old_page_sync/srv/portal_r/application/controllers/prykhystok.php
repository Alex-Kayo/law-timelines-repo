...
class Prykhystok_Controller extends Front_Controller {
     ...
     public function __construct() {
       ...
       // $this->view->front = false;
        ...
        $this->view("prykhystok_subsite/main_prykhystok");
...
// public function appointments(){ 
 public function index(){ 
     ...
     $this->view->prykhystok_news=$this->model->FindBySeo('documents',  'prykhystok_news',  $this->siteLang, $mainPageCount['tsk_topnews']);
...
//     $this->view("tsk_subsite/main_tsk");
     $this->view->tsk_name = 'Тимчасової спеціальної комісії Верховної Ради України з питань захисту прав інвесторів ';
     $this->view->tsk_abt = 'Про Тимчасову спеціальну комісію';
     $this->view->tsk_rsn = 'Підстава для створення ';
     ...
     //   var_dump($mainPageCount); die();
        
        $this->view->prykhystok_news=$this->model->FindBySeo('documents', 'prykhystok_news', $this->siteLang, $mainPageCount['tsk_topnews']);
//        $this->view->tsk_topnews_korup=$this->model->FindBySeo('news', $this->TopNewsTskKorup_Seo, $this->siteLang, $mainPageCount['tsk_topnews']);
     
     
     return true;
 }
 public function tsk1(){ 
...
//     $this->view("tsk_subsite/main_tsk");
     ...
     //   var_dump($mainPageCount); die();
        ...
        $this->view->tsk_topnews=$this->model->FindBySeo('documents', $SeoTsk, $this->siteLang, $mainPageCount['tsk_topnews']);
//        $this->view->tsk_topnews_korup=$this->model->FindBySeo('news', $this->TopNewsTskKorup_Seo, $this->siteLang, $mainPageCount['tsk_topnews']);
