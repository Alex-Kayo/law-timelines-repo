...
class Memorial_Controller extends Main_Page_Controller {
    
     public function __construct() {
        parent::__construct();

        $this->view("memorial_subsite/main_memorial");
    }

 public function index(){

     $this->view->faq_media=$this->model->FindBySeoFullText('news',  'faq_media',  $this->siteLang, 10);
     $this->view->memorial=$this->model->FindBySeo('news',  'memory_m',  $this->siteLang, 8);
...
//var_dump($this->view->press_team); die();
    ...
    public function show() {
        ...
        $this->view('memorial_subsite/show');
